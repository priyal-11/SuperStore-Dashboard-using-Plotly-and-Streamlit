...
st.title(":chart_with_upwards_trend: SuperStore Dashboard")
st.markdown('<style>div.block-container{padding-top:2rem;text-align:center; font-color: red}</style>', unsafe_allow_html=True)
...
if fl is not None:
    ...
    os.chdir(r"C:\Users\priya\OneDrive\Desktop\SuperStore Dashboard Analysis Using Streamlit")
...
# Filter the data based on the region, state, city
...
data1 = px.scatter(filtered_df,x="Sales",y="Profit",color="Category",hover_data=["Region","State","City","Category"])
data1['layout'].update (title = "Realationship between Sales and Profit",
